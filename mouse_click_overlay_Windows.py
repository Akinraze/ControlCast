...
VERSION = "Mouse_Click_Overlay_v1_2_6_AUTO_PROFILE_IO"
...
master_enabled = True
profile_name = "Default Mouse Profile"
profile_path = ""
...
extra_functions = ["Extra Mouse Button %d" % (i + 1) for i in range(10)]
...
def script_description():
    return (
        ...
        "Profile JSON is exported automatically when settings are saved and imported automatically at startup when present.<br>""Diagnostics open in a separate non-blocking Windows results dialog; no OBS text/image source is required.<br><br>""<b>Safety:</b> no Python property-button callbacks are registered."
    ) % VERSION
